...
# HINT 3: Use the replace() method to replace [NAME] with the actual name. https://www.w3schools.com/python/ref_string_replace.asp
    rando_num = random.randint(0,2)
    print(rando_num)
    if rando_num ==0:
        with open("letter_templates/letter_1.txt") as letter_1:
            contents = letter_1.read()
    elif rando_num == 1:
        with open("letter_templates/letter_2.txt") as letter_2:
            contents = letter_2.read()
    elif rando_num == 2:
        with open("letter_templates/letter_3.txt") as letter_3:
            contents = letter_3.read()
    personalized_copy = contents.replace("[NAME]", person_name)
    print("preview")
    print(personalized_copy)
